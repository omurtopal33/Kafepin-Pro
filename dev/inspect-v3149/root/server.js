  ...
  liveMonitorMoveTimer = setTimeout(() => {
    ...
    deleteTelegramMessage(oldMessageId, (deleteErr) => {
      if (deleteErr) {
        ...
        // Telegram eski mesajı silmeyi reddederse canlı durum yukarıda
        // kalmasın. Eski mesajı koru; kaydı sıfırlayıp yeni canlı durumu
        // ayrıca göndererek onu her durumda en son mesaja taşı.
        liveMessageId = 0;
        db.run(
...
const KAFEPIN_DESKTOP_APP_VERSION = "1.1.3";
